...
int main(int argc, char *argv[]) {
    ...
    if (z == "help") {
        ...
        while (!(cin >> typ_macierzy)) {
            ...
            cout << endl << "Spróbuj ponownie napisać czy chcesz wykonywać operację na macierzach typu int czy double:"
                 << endl;
            cin.clear();
            cin.ignore();
        }
        if (typ_macierzy == "int") {
            if (z == "addMatrix") {
                ...
                int wierszeA, kolumnyA, wierszeB, kolumnyB;
                cout << "Podaj wymiary macierzy A i B, które chcesz przez siebie przemnożyć (mnozenie AxB):" << endl;
                ...
                int wierszeA, kolumnyA;
                cout << "Podaj wymiary macierzy A, dla której chcesz sprawdzić własność, czy macierz jest diagonalna"
                     << endl;
